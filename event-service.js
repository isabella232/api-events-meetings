...
if (process.argv.length != 6)
{
	...
	console.log("    partition --- the string value from the scope.partition.name field in");
	console.log("         OAuth /token?Password API response");
	console.log("    numeric_meeting_id --- the string value you enter when joining from a client");
	console.log("    user_id   ---  the meeting scheduler's numeric account ID, and is from");
	console.log("         the scope.user field in the OAuth /token?PAssword API response");
	console.log("    access_token   ---  a token generated by the OAuth /token?Meeting API call");
    process.exit(1);
}
